...
# Description:       ex : slidehub server is a node.js http server listening on
#                    port 8000.
#                    place this file in /etc/init.d.
### END INIT INFO

# Author: Alexander Muelli <amuelli@gmail.com>
#
...
DAEMON_ARGS="/home/slidehub/slidehub/server/app.js" # path to your node.js server/app
                                            # NB: don't use ~/ in path

DESC="slidehub node.js http server"                  # whatever fancy description you like

NODEUSER=slidehub:slidehub
