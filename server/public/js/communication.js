...
var communication = {
  ...
  socketNote: function(data) {
    communication.addNote(data.user.username, data.user.md5email, data.note, moment(data.note.timestamp));
  },
   ...
   */
  addNote: function(username, md5email, note, date) {
    var gravatar = '"http://www.gravatar.com/avatar/'+md5email+'?s=32&d=identicon"';
